...
public class ClientReceiverHandler extends SimpleChannelInboundHandler<NodeMessageProto.ClientMessage>
{
	...
	@Override
	protected void channelRead0(ChannelHandlerContext arg0, NodeMessageProto.ClientMessage msg)
			throws Exception 
	{
