...
public class RequestVoteMsgQueue
{
	...
	{
		logger.debug("Pushing Request to RequestVoteMsgQueue : "+ request);
	...
	public static RequestContext pop()
	{
		if(getCount()>0)
		{
			...
			queue.remove(0);
			logger.debug("Popping Message From RequestVoteMsgQueue : "+ request);
			return request;
		}
